...
library(shiny)
runApp("app.R")
The dashboard opens in your browser. You can now explore COVID-19 data interactively.
...
Average CFR: 2.1%, Recovery Rate: 89%, Tests per 100K: 1,800
...
Average CFR: 3.4%, Recovery Rate: 92%, Tests per 100K: 14,200
...
Average CFR: 2.8%, Recovery Rate: 91%, Tests per 100K: 3,500
...
Advanced healthcare system, high testing capacity → CFR 0.08%, exemplary response

Yemen

Healthcare collapse, minimal testing → Estimated CFR 18%+ (likely undercount)

Peru

High per-capita mortality (600 per 100K) despite moderate CFR → Healthcare system overwhelmed

USA

Large variance across states; national aggregation masks regional disparities
